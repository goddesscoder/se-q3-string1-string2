...
def donuts(count):
    ...
    if (donut_count < 10):
        # How do I concantenate when using return?
        return "Number of donuts: " + str(donut_count)
    else:
...
def fix_start(s):
    ...
    stra = word[0]
    strb = "*"
    new_word = word.replace(stra, strb)[1:]
    return stra + new_word
